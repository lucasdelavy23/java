...
public class Desafio01e02 {
    public static void main(String[] args) {
        /*Crie um programa que permita ao usu´ario cadastrar produtos e seusrespectivos preços. 
            O programa deve ler pares de valores (nome do produto e pre¸co) e armazen´a-los em uma estrutura adequada.
            A entrada deve continuar at´e que o usu´ario informe que deseja encerrar o cadastro. Ao final, o programa deve exibir todos os produtos cadastrados 
