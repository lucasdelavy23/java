...
public class Questao20 {
    public static void main(String[] args) {
        /*Crie um programa que simule um pequeno sistema de cadastro de produtos. O programa
        deve permitir ao usuario inserir nomes de produtos e seus respectivos precos, armazenando essas informacoes 
        em uma estrutura apropriada. Apos o cadastro, o programa
        deve permitir que o usuario consulte um produto pelo nome e exiba seu preco. Caso o
       produto nao exista, o programa deve informar que o produto nao foi encontrado.*/
